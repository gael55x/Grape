...
export function helpText(): string {
  return [
    ...
    "  --client <name>             MCP install client: cursor or claude",
...
const COMMAND_HELP: Readonly<Record<string, string>> = {
  ...
  mcp: [
    ...
    "",
    "Installs MCP client config, prints manual MCP client JSON, or serves Grape tools over stdio.",
    "",
    "Install behavior:",
    ...
    "  --dry-run prints the target path and final JSON without writing.",
