...
- Implementation planning now uses goal names: Documentation Foundation and Alpha Context Loop.
...
- Added Alpha Context Loop plan with scoped work tickets and exit criteria.
...
- Added current-valid filtering skeleton and consolidated Alpha Context Loop smoke checks.
