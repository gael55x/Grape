...
- Added `grape compact` for preview-first context artifact retention cleanup. `--confirm` is required before it deletes eligible old artifact rows or regular files under `.grape/artifacts/`.
