...
|---|---|---|---|---|---|
| The pinned `windows-2025` runner started reporting a redirect notice to `windows-2025-vs2026` by June 15, 2026. | `.github/workflows/check.yml`; GitHub Actions run `27449467206`; official `actions/runner-images` label table. | A beta package gate should not keep a runner label that GitHub says will redirect to a more specific image. | Pin the Windows matrix leg to `windows-2025-vs2026`. | Watch the first hosted run on `windows-2025-vs2026` and confirm the notice is gone. | Hosted image labels can change again; revisit the workflow when GitHub reports a new runner warning. |
...
- Hosted cross-platform CI now passes for the current alpha.3 gate, including the v6 GitHub action workflow. The Windows matrix leg is being moved from `windows-2025` to the documented `windows-2025-vs2026` label after GitHub run `27449467206` reported a redirect notice.
