...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `clean-typescript-app` | 3481 | 1678 | 58.29% | 41043 | 281.91% | 7 | 1 | 0 |
| `branch-switch-typescript-app` | 3481 | 4110 | 0% | 44219 | 287.44% | 0 | 9 | 0 |
| `stale-source-typescript-app` | 3481 | 4349 | 0% | 45364 | 286.04% | 0 | 9 | 0 |
| `session-reset-typescript-app` | 3790 | 4959 | 0% | 47698 | 285.53% | 0 | 9 | 0 |
...
Benchmark output also reports serialized context-pack token estimates, serialized default agent-output token estimates, and token breakdowns by diff state and section. These are transport diagnostics: body-token counts explain logical context savings, serialized-pack counts show JSON overhead from metadata, restore hints, and dependency references, and serialized-agent-output counts estimate the default MCP `agent_pack` frame including compact text summary, compact preview structured content, and graph adjacency.
