...
- Capability opacity: agents see selected provider capability gaps and a repo-level indexed provider summary by language/provider, but not a complete provider capability report per package.
