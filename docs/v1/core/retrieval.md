...
- Caller-supplied feature flags may filter current-valid claims whose scope already contains matching `featureFlag` or `featureFlags` data. They do not create claims, prove runtime behavior, or appear as raw public output values.
