...
Update this folder when artifact sections, dependency manifests, diff states, sent ledgers, omitted items, or restore behavior changes. Update `transport-stability.md` when MCP request/response fields are added, reclassified, or removed.
