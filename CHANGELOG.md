...
- Added `grape compact` for preview-first context artifact retention cleanup. It requires `--confirm` before deleting eligible old artifact rows or regular artifact files.
