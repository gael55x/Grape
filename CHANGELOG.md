...
- Added `grape compact` for preview-first context artifact and compression cache retention cleanup. It requires `--confirm` before deleting eligible old artifact rows, regular artifact files, or unreferenced compression cache rows.
